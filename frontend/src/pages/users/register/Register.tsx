...
const Register = () => {
  return (<>
    <Navbar/>
    <div className="w-screen h-screen bg-[#ecebc7] flex justify-center items-center flex-col">
        ...
        <div className="w-140 h-120 bg-slate-800 rounded-4xl flex justify-center items-center border-4 border-slate-900 shadow-sm shadow-black">
            <form action="http://localhost:8000/user/register" method="post" className="flex justify-around items-center flex-col w-full h-[60%]">
                ...
                <button type="submit" className="font-medium tracking-wide bg-gray-900 w-70 px-3 py-2 outline-0 rounded-md text-gray-400 mt-5 mb-4 cursor-pointer shadow-black shadow-sm hover:shadow-md transition-all duration-100">Register</button>
